...
var require_ort_min = __commonJS({
  "node_modules/onnxruntime-web/dist/ort.min.js"(exports, module) {
    ...
    var ort = (() => {
      ...
      var nt = (e, t) => {
        for (var n in t) wn(e, n, { get: t[n], enumerable: true });
      }, Wu = (e, t, n, r) => {
        if (t && typeof t == "object" || typeof t == "function") for (let o of Nu(t)) !Lu.call(e, o) && o !== n && wn(e, o, { get: () => t[o], enumerable: !(r = Vu(t, o)) || r.enumerable });
        return e;
      };
        ...
        xt = /* @__PURE__ */ new Map(), je = [], We = (e, t, n) => {
          if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
            ...
            if (n >= 0) {
              let o = je.indexOf(e);
              o !== -1 && je.splice(o, 1);
              for (let i = 0; i < je.length; i++) if (xt.get(je[i]).priority <= n) {
                je.splice(i, 0, e);
                return;
              }
              je.push(e);
      ...
      var Tt, Vr = k(() => {
        ...
        Tt = class e {
          ...
          async run(t, n, r) {
            ...
            let o = {}, i = {};
            if (typeof t != "object" || t === null || t instanceof ve || Array.isArray(t)) throw new TypeError("'feeds' must be an object that use input names as keys and OnnxValue as corresponding values.");
            let s = true;
            if (typeof n == "object") {
              if (n === null) throw new TypeError("Unexpected argument[1]: cannot be null.");
              if (n instanceof ve) throw new TypeError("'fetches' cannot be a Tensor");
              if (Array.isArray(n)) {
      ...
      var kn, Pn, Ut, no, Qu, Xu, Yu, At, ne, Ge = k(() => {
        ...
        Pn = false, Ut = false, no = false, Qu = () => {
          ...
          if (e.simd !== false) {
            if (e.simd === "relaxed") {
              if (!Yu()) throw new Error("Relaxed WebAssembly SIMD is not supported in the current environment.");
          ...
          let o = e.wasmPaths, i = typeof o == "string" ? o : void 0, s = o?.mjs, a = s?.href ?? s, u = o?.wasm, d = u?.href ?? u, l = e.wasmBinary, [c, p] = await to(a, i, n > 1, !!l || !!d), f = false, m = [];
      ...
      var ro, oo = k(() => {
        ...
        ro = (e) => {
          ...
          try {
            ...
            let i = 0;
            return e?.tag !== void 0 && (i = _e(e.tag, r)), n = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), n === 0 && Y("Can't create run options."), e?.extra !== void 0 && mt(e.extra, "", /* @__PURE__ */ new WeakSet(), (s, a) => {
        ...
        Ju = (e) => {
          ...
          for (let r of t) {
            ...
            if (a > 0) {
              ...
              for (let l = 0; l < a; l++) ne().setValue(u + l * ne().PTR_SIZE, i[l][0], "*"), ne().setValue(d + l * ne().PTR_SIZE, i[l][1], "*");
            }
        ...
        mo = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), Un = (e, t) => {
          ...
          async ensureTensor(t, n, r, o) {
            ...
            if (!i.opSupportLimits().input.dataTypes.includes(n)) {
              if (s = ad.get(n), !s || !i.opSupportLimits().input.dataTypes.includes(s)) throw new Error(`WebNN backend does not support data type: ${n}`);
            ...
            if (this.wrapper) {
              ...
              if (o) {
                if (this.wrapper.byteLength !== ho(n, r)) throw new Error("Unable to copy data to tensor with different size.");
          ...
          upload(t) {
            let n = t;
            if (this.wrapper) {
              if (this.wrapper.fallbackType) if (this.wrapper.fallbackType === "int32") n = Un(t, this.wrapper.type), this.wrapper.setIsDataConverted(true);
              ...
              if (t.byteLength === this.wrapper.byteLength) {
                ...
                return;
              } else j("verbose", () => "Data size does not match tensor size. Releasing tensor."), this.releaseTensor();
            }
            this.activeUpload ? this.activeUpload.set(n) : this.activeUpload = new Uint8Array(n);
          }
          async download(t) {
            if (this.activeUpload) {
              let n = this.wrapper?.isDataConverted ? fo(this.activeUpload, this.wrapper?.type) : this.activeUpload;
              if (t) {
          ...
          async download(t, n) {
            j("verbose", () => `[WebNN] TensorManager.download {tensorId: ${t}, dstBuffer: ${n?.byteLength}}`);
            let r = this.tensorTrackersById.get(t);
            if (!r) throw new Error("Tensor not found.");
            return r.download(n);
          }
      ...
      var Kt, ud, jt, bo = k(() => {
        ...
        Kt = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), ud = (e, t) => {
          ...
          onRunEnd(t) {
            ...
            if (n) {
              for (let r of n) j("verbose", () => `[WebNN] releasing temporary tensor {tensorId: ${r}}`), this.tensorManager.releaseTensorId(r);
          ...
          isGraphInputOutputTypeSupported(t, n, r = true) {
            ...
            return typeof i > "u" ? false : r ? !!o?.opSupportLimits().input.dataTypes.includes(i) : !!o?.opSupportLimits().output.dataTypes.includes(i);
          }
          flush() {
          }
        };
      ...
      var _o, Rn, Vn, dd, ld, wo, Ln, Nn, vo, xo = k(() => {
        ...
        _o = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), Rn = [], Vn = (e) => Math.ceil(Number(e) / 16) * 16, dd = (e) => {
          ...
          constructor(t) {
            ...
            for (let [n] of _o) Rn.push(n), this.freeBuffers.set(n, []), this.freeUniformBuffers.set(n, []);
            this.sessionCount = 0;
          }
          upload(t, n) {
          ...
          registerExternalBuffer(t, n, r) {
            let o;
            if (r) {
              if (o = r[0], t === r[1]) return j("verbose", () => `[WebGPU] GpuDataManager.registerExternalBuffer(size=${n}) => id=${o}, buffer is the same, skip.`), o;
  ...
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
            ...
            if (p.storage === "vec2<u32>" && p.value === "i32") return `${e}[${E}]=vec2<u32>(u32(${L}), select(0u, 0xFFFFFFFFu, ${L} < 0));`;
            if (p.storage === "vec2<u32>" && p.value === "u32") return `${e}[${E}]=vec2<u32>(u32(${L}), 0u);`;
            if (p.storage === "u32" && p.value === "vec4<bool>") return `${e}[${E}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${L}));`;
        ...
        fl = (e, t, n, r, o, i) => {
          ...
          if (h || l === 1 && c === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 && n.strides[0] === 1 && n.strides[1] === 1 && n.pads[0] === 0 && n.pads[1] === 0) {
            ...
            if (o) {
              ...
              } else T = t[0].reshape([$, a * u, d]), I = G.reshape([1, d, m]), A = [$, p * f, m];
              z.push(T), z.push(I);
...
`, Zl = (e, t, n) => (() => {
  ...
  ${c.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
          ...
          } else return i.dims.length === 3 && (u = i.reshape([t, r, n, o])), n === 1 || r === 1 ? u : e.compute(pe(u, aa.perm), { inputs: [u], outputs: [-1] })[0];
        }, da = (e, t) => {
      ...
      ${(() => {
            ...
            `;
              case "cubic":
                return `
            ${(() => {
                  if (s.length === 2 || s.length === 4) return `${Fc(c, l, s, u, d, a, t.cubicCoeffA, m, t.extrapolationValue, t.excludeOutside)}`;
...
`}
      ...
      var mu, op, ip, sp, fu, hu = k(() => {
        ...
        mu = (e) => Array.from(e.getBigInt64Array(), Number), op = (e) => {
          ...
          if (mu(e[1]).length !== e[0].dims.length) throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor");
        }, ip = (e, t) => {
          let n = [];
...
${a}`, d = r.createShaderModule({ code: u, label: t.name });
      ...
      var dp, lp, lr, cr, vu = k(() => {
        ...
        dp = (e, t) => {
          ...
          let r = e.name;
          return e.shaderCache?.hint && (r += "[" + e.shaderCache.hint + "]"), r += ":" + n + `:${dp(t, e.shaderCache?.inputDependencies ?? new Array(t.length).fill("dims"))}`, r;
        }, lr = class {
          constructor(t) {
        ...
        wt = class e {
          ...
          if (e === "webgpu") {
            ...
            await s.initialize(n, r), o("webgpu", [s, (a) => s.alloc(Number(a)), (a) => s.free(a), (a, u, d, l = false) => {
              if (l) j("verbose", () => `[WebGPU] jsepCopyGpuToGpu: src=${Number(a)}, dst=${Number(u)}, size=${Number(d)}`), s.memcpy(Number(a), Number(u));
              else {
      ...
      var pp, Et, kt, et, mp, Tu, pt, Pt, zt, Iu, Bt, Dt, Ot, An = k(() => {
        ...
        pp = (e, t) => {
          ...
          try {
            ...
            let [c, p] = mp(i), f = !!t?.enableGraphCapture, m = [], h = [], b = [], y = [], g = [];
            for (let w = 0; w < c; w++) {
              let [v, $, T] = Tu(i, w);
          ...
          try {
            ...
            for (let B = 0; B < h; B++) s.setValue(T + B * a, _[B], "*"), s.setValue(I + B * a, l[t[B]], "*");
            for (let B = 0; B < b; B++) s.setValue(A + B * a, w[B], "*"), s.setValue(z + B * a, c[r[B]], "*");
            if (p && !m) {
              ...
              for (let D = 0; D < b; D++) {
                let Z = r[D];
                o[D]?.[3] ? s._OrtBindOutput(B, c[Z], w[D], 0) !== 0 && Y(`Can't bind pre-allocated output[${D}] for session=${e}.`) : s._OrtBindOutput(B, c[Z], 0, W[Z]) !== 0 && Y(`Can't bind output[${D}] to ${ee[D]} for session=${e}.`);
              }
            ...
            for (let B = 0; B < b; B++) {
              ...
              try {
                ...
                R = Ee(H);
                let Se = p?.outputPreferredLocations[r[B]];
                if (R === "string") {
                  ...
                  if (!ue) throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');
                  let ae = ue(Q), Le = qe(H, $e);
                  if (Le === void 0 || !Nt(R)) throw new Error(`Unsupported data type: ${R}`);
                  ...
                  if (!ue || !ae) throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');
                  if (qe(H, $e) === void 0 || !Lt(R)) throw new Error(`Unsupported data type: ${R}`);
                  if (!ae(e, R, false)) throw new Error(`preferredLocation "ml-tensor" for ${R} output is not supported by current WebNN Context.`);
            ...
            s.webnnOnRunEnd?.(d), s.stackRestore($), _.forEach((M) => s._OrtReleaseTensor(M)), w.forEach((M) => s._OrtReleaseTensor(M)), v.forEach((M) => s._free(M)), y !== 0 && s._OrtReleaseRunOptions(y), g.forEach((M) => s._free(M));
          }
        }, Dt = (e) => {
          let t = ne(), n = et.get(e);
      ...
      var tt, xe, $t, gn, yn, hn, mr, fr, at, ut, hp, Cu, Au, Eu, ku, Pu, zu, Bu, hr = k(() => {
        ...
        tt = () => !!te.wasm.proxy && typeof document < "u", $t = false, gn = false, yn = false, fr = /* @__PURE__ */ new Map(), at = (e, t) => {
          ...
          if ($t || !gn || yn || !xe) throw new Error("worker not ready");
        }, hp = (e) => {
          switch (e.data.type) {
            case "init-wasm":
          ...
          if (!gn) {
            ...
            if ($t = true, tt()) return new Promise((e, t) => {
              xe?.terminate(), eo().then(([n, r]) => {
                try {
          ...
          if (tt()) return ut(), new Promise((t, n) => {
            at("init-ep", [t, n]);
      ...
      var Du, gp, bn, Ou = k(() => {
        ...
        Du = (e, t) => {
          ...
          switch (e[3]) {
            ...
            case "gpu-buffer": {
              let t = e[0];
              if (!Nt(t)) throw new Error(`not supported data type: ${t} for deserializing GPU tensor`);
              let { gpuBuffer: n, download: r, dispose: o } = e[2];
              return ve.fromGpuBuffer(n, { dataType: t, dims: e[1], download: r, dispose: o });
            }
            case "ml-tensor": {
              let t = e[0];
              if (!Lt(t)) throw new Error(`not supported data type: ${t} for deserializing MLTensor tensor`);
...
// node_modules/@ricky0123/vad/dist/index.browser.js
var require_index_browser = __commonJS({
  "node_modules/@ricky0123/vad/dist/index.browser.js"(exports, module) {
    !(function(e, t) {
      "object" == typeof exports && "object" == typeof module ? module.exports = t(require_ort_min()) : "function" == typeof define && define.amd ? define(["onnxruntime-web"], t) : "object" == typeof exports ? exports.vad = t(require_ort_min()) : e.vad = t(e.ort);
    })(self, ((e) => (() => {
      "use strict";
      var t = { 656: (t2) => {
        t2.exports = e;
      ...
      function i(e2) {
        ...
        var o = s[e2] = { exports: {} };
        return t[e2](o, o.exports, i), o.exports;
      }
      i.d = (e2, t2) => {
        ...
        var e2;
        i.g.importScripts && (e2 = i.g.location + "");
        var t2 = i.g.document;
        if (!e2 && t2 && (t2.currentScript && (e2 = t2.currentScript.src), !e2)) {
          var s2 = t2.getElementsByTagName("script");
          s2.length && (e2 = s2[s2.length - 1].src);
        }
        if (!e2) throw new Error("Automatic publicPath is not supported in this browser");
        e2 = e2.replace(/#.*$/, "").replace(/\?.*$/, "").replace(/\/[^\/]+$/, "/"), i.p = e2;
      })();
      var r = {};
      return (() => {
        function e2(e3, t3, s3) {
          for (var i2 = 0; i2 < s3.length; i2++, t3 += 4) e3.setFloat32(t3, s3[i2], true);
        }
        function t2(e3, t3, s3) {
          for (var i2 = 0; i2 < s3.length; i2++, t3 += 2) {
            var r2 = Math.max(-1, Math.min(1, s3[i2]));
            e3.setInt16(t3, r2 < 0 ? 32768 * r2 : 32767 * r2, true);
          }
        }
        function s2(e3, t3, s3) {
          for (var i2 = 0; i2 < s3.length; i2++) e3.setUint8(t3 + i2, s3.charCodeAt(i2));
        }
        let o;
        i.r(r), i.d(r, { AudioNodeVAD: () => P, FrameProcessor: () => l, Message: () => o, MicVAD: () => T, NonRealTimeVAD: () => y, utils: () => D }), (function(e3) {
          e3.AudioFrame = "AUDIO_FRAME", e3.SpeechStart = "SPEECH_START", e3.VADMisfire = "VAD_MISFIRE", e3.SpeechEnd = "SPEECH_END";
        })(o || (o = {}));
        const n = "[VAD]", a = ["error", "debug", "warn"].reduce(((e3, t3) => (e3[t3] = /* @__PURE__ */ (function(e4) {
          return function() {
            for (var t4 = arguments.length, s3 = new Array(t4), i2 = 0; i2 < t4; i2++) s3[i2] = arguments[i2];
            console[e4](n, ...s3);
          };
        })(t3), e3)), {});
        function h(e3, t3, s3) {
        ...
        const c = [512, 1024, 1536], p = { positiveSpeechThreshold: 0.5, negativeSpeechThreshold: 0.35, preSpeechPadFrames: 1, redemptionFrames: 8, frameSamples: 1536, minSpeechFrames: 3 };
        function u(e3) {
          c.includes(e3.frameSamples) || a.warn("You are using an unusual frame size"), (e3.positiveSpeechThreshold < 0 || e3.negativeSpeechThreshold > 1) && a.error("postiveSpeechThreshold should be a number between 0 and 1"), (e3.negativeSpeechThreshold < 0 || e3.negativeSpeechThreshold > e3.positiveSpeechThreshold) && a.error("negativeSpeechThreshold should be between 0 and postiveSpeechThreshold"), e3.preSpeechPadFrames < 0 && a.error("preSpeechPadFrames should be positive"), e3.redemptionFrames < 0 && a.error("preSpeechPadFrames should be positive");
        }
        const d = (e3) => {
          const t3 = e3.reduce(((e4, t4) => (e4.push(e4.at(-1) + t4.length), e4)), [0]), s3 = new Float32Array(t3.at(-1));
          return e3.forEach(((e4, i2) => {
            const r2 = t3[i2];
            s3.set(e4, r2);
          })), s3;
        };
        class l {
          constructor(e3, t3, s3) {
            h(this, "speaking", false), h(this, "redemptionCounter", 0), h(this, "active", false), h(this, "reset", (() => {
              this.speaking = false, this.audioBuffer = [], this.modelResetFunc(), this.redemptionCounter = 0;
            })), h(this, "pause", (() => {
              this.active = false, this.reset();
            })), h(this, "resume", (() => {
              this.active = true;
            })), h(this, "endSegment", (() => {
              const e4 = this.audioBuffer;
              this.audioBuffer = [];
              const t4 = this.speaking;
              this.reset();
              const s4 = e4.reduce(((e5, t5) => e5 + +t5.isSpeech), 0);
              if (t4) {
                if (s4 >= this.options.minSpeechFrames) {
                  const t5 = d(e4.map(((e5) => e5.frame)));
                  return { msg: o.SpeechEnd, audio: t5 };
                }
                return { msg: o.VADMisfire };
              }
              return {};
            })), h(this, "process", (async (e4) => {
              if (!this.active) return {};
              const t4 = await this.modelProcessFunc(e4);
              if (this.audioBuffer.push({ frame: e4, isSpeech: t4.isSpeech >= this.options.positiveSpeechThreshold }), t4.isSpeech >= this.options.positiveSpeechThreshold && this.redemptionCounter && (this.redemptionCounter = 0), t4.isSpeech >= this.options.positiveSpeechThreshold && !this.speaking) return this.speaking = true, { probs: t4, msg: o.SpeechStart };
              if (t4.isSpeech < this.options.negativeSpeechThreshold && this.speaking && ++this.redemptionCounter >= this.options.redemptionFrames) {
                this.redemptionCounter = 0, this.speaking = false;
                const e5 = this.audioBuffer;
                if (this.audioBuffer = [], e5.reduce(((e6, t5) => e6 + +t5.isSpeech), 0) >= this.options.minSpeechFrames) {
                  const s4 = d(e5.map(((e6) => e6.frame)));
                  return { probs: t4, msg: o.SpeechEnd, audio: s4 };
                }
                return { probs: t4, msg: o.VADMisfire };
              }
              if (!this.speaking) for (; this.audioBuffer.length > this.options.preSpeechPadFrames; ) this.audioBuffer.shift();
              return { probs: t4 };
            })), this.modelProcessFunc = e3, this.modelResetFunc = t3, this.options = s3, this.audioBuffer = [], this.reset();
          }
        }
        const m = i.p + "568bf886c02ac597add4.onnx";
        function f(e3, t3, s3) {
          return t3 in e3 ? Object.defineProperty(e3, t3, { value: s3, enumerable: true, configurable: true, writable: true }) : e3[t3] = s3, e3;
        }
        let S;
        ...
        class g {
          constructor() {
            f(this, "init", (async () => {
              a.debug("initializing vad");
              const e3 = await fetch(m).then(((e4) => e4.arrayBuffer()));
              this._session = await S.InferenceSession.create(e3), this._sr = new S.Tensor("int64", [16000n]), this.reset_state(), a.debug("vad is initialized");
            })), f(this, "reset_state", (() => {
              const e3 = Array(128).fill(0);
              this._h = new S.Tensor("float32", e3, [2, 1, 64]), this._c = new S.Tensor("float32", e3, [2, 1, 64]);
            })), f(this, "process", (async (e3) => {
              const t3 = { input: new S.Tensor("float32", e3, [1, e3.length]), h: this._h, c: this._c, sr: this._sr }, s3 = await this._session.run(t3);
              this._h = s3.hn, this._c = s3.cn;
              const [i2] = s3.output.data;
              return { notSpeech: 1 - i2, isSpeech: i2 };
            }));
          }
        }
        f(g, "new", (async () => {
          const e3 = new g();
          return await e3.init(), e3;
        }));
        class v {
          constructor(e3) {
            var t3, s3;
            s3 = (e4) => {
              const t4 = [];
              for (const t5 of e4) this.inputBuffer.push(t5);
              for (; this.inputBuffer.length * this.options.targetSampleRate / this.options.nativeSampleRate > this.options.targetFrameSize; ) {
                const e5 = new Float32Array(this.options.targetFrameSize);
                let s4 = 0, i2 = 0;
                for (; s4 < this.options.targetFrameSize; ) {
                  let t5 = 0, r2 = 0;
                  for (; i2 < Math.min(this.inputBuffer.length, (s4 + 1) * this.options.nativeSampleRate / this.options.targetSampleRate); ) t5 += this.inputBuffer[i2], r2++, i2++;
                  e5[s4] = t5 / r2, s4++;
                }
                this.inputBuffer = this.inputBuffer.slice(i2), t4.push(e5);
              }
              return t4;
            }, (t3 = "process") in this ? Object.defineProperty(this, t3, { value: s3, enumerable: true, configurable: true, writable: true }) : this[t3] = s3, this.options = e3, e3.nativeSampleRate < 16e3 && a.error("nativeSampleRate is too low. Should have 16000 = targetSampleRate <= nativeSampleRate"), this.inputBuffer = [];
          }
        }
        function w(e3, t3, s3) {
          return t3 in e3 ? Object.defineProperty(e3, t3, { value: s3, enumerable: true, configurable: true, writable: true }) : e3[t3] = s3, e3;
        ...
        class y {
          static async new() {
            const e3 = new y({ ...b, ...arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {} });
            return await e3.init(), e3;
          }
          constructor(e3) {
            w(this, "init", (async () => {
              const e4 = await g.new();
              this.frameProcessor = new l(e4.process, e4.reset_state, { frameSamples: this.options.frameSamples, positiveSpeechThreshold: this.options.positiveSpeechThreshold, negativeSpeechThreshold: this.options.negativeSpeechThreshold, redemptionFrames: this.options.redemptionFrames, preSpeechPadFrames: this.options.preSpeechPadFrames, minSpeechFrames: this.options.minSpeechFrames }), this.frameProcessor.resume();
            })), w(this, "run", (async function* (e4, t3) {
              const s3 = { nativeSampleRate: t3, targetSampleRate: 16e3, targetFrameSize: this.options.frameSamples }, i2 = new v(s3).process(e4);
              let r2, n2;
              for (const e5 of [...Array(i2.length)].keys()) {
                const t4 = i2[e5], { msg: s4, audio: a3 } = await this.frameProcessor.process(t4);
                switch (s4) {
                  case o.SpeechStart:
                    r2 = e5 * this.options.frameSamples / 16;
                    break;
                  case o.SpeechEnd:
                    n2 = (e5 + 1) * this.options.frameSamples / 16, yield { audio: a3, start: r2, end: n2 };
                }
              }
              const { msg: a2, audio: h2 } = this.frameProcessor.endSegment();
              a2 == o.SpeechEnd && (yield { audio: h2, start: r2, end: i2.length * this.options.frameSamples / 16 });
            })), this.options = e3, u(e3);
          }
        }
        function F(e3, t3, s3) {
          return t3 in e3 ? Object.defineProperty(e3, t3, { value: s3, enumerable: true, configurable: true, writable: true }) : e3[t3] = s3, e3;
        }
        const A = { ...p, onFrameProcessed: (e3) => {
        }, onVADMisfire: () => {
          a.debug("VAD misfire");
        }, onSpeechStart: () => {
          a.debug("Detected speech start");
        }, onSpeechEnd: () => {
          a.debug("Detected speech end");
        } };
        class T {
          static async new() {
          ...
          constructor(e3) {
            F(this, "listening", false), F(this, "init", (async () => {
              this.stream = await navigator.mediaDevices.getUserMedia({ audio: { ...this.options.additionalAudioConstraints, channelCount: 1, echoCancellation: true, autoGainControl: true, noiseSuppression: true } }), this.audioContext = new AudioContext();
              const e4 = new MediaStreamAudioSourceNode(this.audioContext, { mediaStream: this.stream });
              this.audioNodeVAD = await P.new(this.audioContext, this.options), this.audioNodeVAD.receive(e4);
            })), F(this, "pause", (() => {
              this.audioNodeVAD.pause(), this.listening = false;
            })), F(this, "start", (() => {
              this.audioNodeVAD.start(), this.listening = true;
            })), this.options = e3, u(e3);
          }
        }
        class P {
          static async new(e3) {
            ...
            const s3 = new P(e3, { ...A, ...t3 });
            return await s3.init(), s3;
          }
          constructor(e3, t3) {
            F(this, "pause", (() => {
              ...
              e4.connect(this.entryNode);
            })), F(this, "processFrame", (async (e4) => {
              const { probs: t4, msg: s3, audio: i2 } = await this.frameProcessor.process(e4);
              switch (void 0 !== t4 && this.options.onFrameProcessed(t4), s3) {
                case o.SpeechStart:
                ...
                case o.VADMisfire:
                  ...
                  break;
                case o.SpeechEnd:
                  this.options.onSpeechEnd(i2);
              }
            })), F(this, "init", (async () => {
              const e4 = i.p + "vad.worklet.js";
              await this.ctx.audioWorklet.addModule(e4);
              const t4 = new AudioWorkletNode(this.ctx, "vad-helper-worklet", { processorOptions: { frameSamples: this.options.frameSamples } });
              this.entryNode = t4;
              const s3 = await g.new();
              this.frameProcessor = new l(s3.process, s3.reset_state, { frameSamples: this.options.frameSamples, positiveSpeechThreshold: this.options.positiveSpeechThreshold, negativeSpeechThreshold: this.options.negativeSpeechThreshold, redemptionFrames: this.options.redemptionFrames, preSpeechPadFrames: this.options.preSpeechPadFrames, minSpeechFrames: this.options.minSpeechFrames }), t4.port.onmessage = async (e5) => {
                var t5;
                if ((null === (t5 = e5.data) || void 0 === t5 ? void 0 : t5.message) === o.AudioFrame) {
                  const t6 = e5.data.data, s4 = new Float32Array(t6);
                  await this.processFrame(s4);
                }
              };
            })), this.ctx = e3, this.options = t3, u(t3);
          }
        }
        const D = { minFramesForTargetMS: function(e3, t3) {
          let s3 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 16e3;
          return Math.ceil(e3 * s3 / 1e3 / t3);
        }, arrayBufferToBase64: function(e3) {
          for (var t3 = "", s3 = new Uint8Array(e3), i2 = s3.byteLength, r2 = 0; r2 < i2; r2++) t3 += String.fromCharCode(s3[r2]);
          return btoa(t3);
        }, audioFileToArray: async function(e3) {
          const t3 = new OfflineAudioContext(1, 1, 44100), s3 = new FileReader();
          let i2 = null;
          if (await new Promise(((r3) => {
            s3.addEventListener("loadend", ((e4) => {
              const o3 = s3.result;
              t3.decodeAudioData(o3, ((e5) => {
                i2 = e5, t3.startRendering().then(((e6) => {
                  console.log("Rendering completed successfully"), r3();
                })).catch(((e6) => {
                  console.error(`Rendering failed: ${e6}`);
                }));
              }), ((e5) => {
                console.log(`Error with decoding audio data: ${e5}`);
              }));
            })), s3.readAsArrayBuffer(e3);
          })), null === i2) throw Error("some shit");
          let r2 = i2, o2 = new Float32Array(r2.length);
          for (let e4 = 0; e4 < r2.length; e4++) for (let t4 = 0; t4 < r2.numberOfChannels; t4++) o2[e4] += r2.getChannelData(t4)[e4];
          return { audio: o2, sampleRate: r2.sampleRate };
        }, encodeWAV: function(i2) {
          let r2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 3, o2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 16e3, n2 = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1, a2 = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 32;
          var h2 = a2 / 8, c2 = n2 * h2, p2 = new ArrayBuffer(44 + i2.length * h2), u2 = new DataView(p2);
          return s2(u2, 0, "RIFF"), u2.setUint32(4, 36 + i2.length * h2, true), s2(u2, 8, "WAVE"), s2(u2, 12, "fmt "), u2.setUint32(16, 16, true), u2.setUint16(20, r2, true), u2.setUint16(22, n2, true), u2.setUint32(24, o2, true), u2.setUint32(28, o2 * c2, true), u2.setUint16(32, c2, true), u2.setUint16(34, a2, true), s2(u2, 36, "data"), u2.setUint32(40, i2.length * h2, true), 1 === r2 ? t2(u2, 44, i2) : e2(u2, 44, i2), p2;
        } };
      })(), r;
    })()));
  }
...
//# sourceMappingURL=@ricky0123_vad.js.map
